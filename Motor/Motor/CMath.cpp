...
const Vector3 Vector3::Infinity(CMath::Infinity, CMath::Infinity, CMath::Infinity);
const Vector3 Vector3::NegInfinity(CMath::NegInfinity, CMath::NegInfinity, CMath::NegInfinity);
...
Vector3 Vector3::TransformWithPerspDiv(const Vector3& vec, const Matrix4& mat, float w /*= 1.0f*/)
{
	...
	if (!CMath::NearZero(CMath::Abs(transformedW)))
	{
